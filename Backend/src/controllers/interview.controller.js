...
async function generateInterViewReportController(req, res) {
    try {
        ...
        if (!req.file && !selfDescription) {
            return res.status(400).json({ message: "Please upload a resume or provide a self description." })
        }
        ...
        const title = interViewReportByAi.title || jobDescription.slice(0, 60)
